...
- Introduction to the course & Introduction to Python (1)
...
**Aims:** To learn some basic principles of high-performance computing, and run a specific workflow on the SWC system
